...
//
// This simply changes the config to allows the deserielizer to attempt to deserialize any class that is a dev.lydtech
...
// so changing the production cpnfig is not really the right thing to do unless it should genuinely needs to allow
